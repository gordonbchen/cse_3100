...
// Items in linked list, employees remove item from front of LL, prepare, then put into sliding tray
// Sliding tray: 3 cols (drink, fries, burger), limited capcity so employees wait if full
// Any customer can pick up order from sliding tray
